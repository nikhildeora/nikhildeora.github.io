...
const About = () => {
  return (
    <section className="about section" id="about">
        ...
        <div className="about__container container mygrid">
          <img src={MyImage} alt="myimage" />
          <div>
            <h1 className="about__greet">Hey... 
                </h1>
