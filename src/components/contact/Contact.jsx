      ...
      <div className={styles.contact_maindiv}>
        <div>
          ...
          <div className={styles.contact__socialdivs}>
            ...
            <h4>Email</h4>
            <p>fitnexy@gmail.com</p>
            <a href="mailto:fitnexy@gmail.com">Click here to mail{" "}<i className="bx bx-right-arrow-alt"></i></a>
          </div>
          ...
          <div className={styles.contact__socialdivs}>
            ...
            <h4>Whatsapp</h4>
            <p>+91 7597439343</p>
            <a href="https://api.whatsapp.com/send?phone=+917597439343&text=Hello, more information!" className="contact__button">Click here to message {" "}<i className="bx bx-right-arrow-alt"></i></a>
          </div>
